  ...
  return {
    ...
    builder: (yargs) => {
      yargs
        ...
        .option('html-folder', {
          alias: 'htmlFolder',
          describe: 'Serve HTML files from this folder without extensions. Use FOLDER:MOUNT syntax to control URL path (e.g., content:/ serves at root, drafts:/preview serves at /preview). Defaults to serving at /FOLDER.',
          type: 'string',
        })
